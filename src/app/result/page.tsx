  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto text-center mb-8">
        <div className="backdrop-blur-md bg-slate-800/50 border border-slate-600/30 rounded-xl p-8 shadow-lg">
          <div className="text-6xl mb-4">{scoreInfo.icon}</div>
          <h1 className="text-3xl font-bold mb-2">クイズ完了！</h1>
          {result.difficulty && (
            <p className="text-cyan-300 mb-2">難易度: {result.difficulty}</p>
          )}
            ...
            >
              <div className="flex items-start mb-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-3">
                    <p className="text-sm text-slate-400 mb-1">あなたの回答:</p>
                  ...
                  {!answered.isCorrect && (
                    <div className="mb-3">
                      <p className="text-sm text-slate-400 mb-1">正解:</p>
                  ...
                  <div className="rounded-lg p-4 border border-slate-600/30 bg-slate-800/30">
                    <p className="text-sm font-medium text-slate-300 mb-2">解説:</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Link
          href="/"
          className="flex items-center justify-center px-6 py-3 bg-gradient-to-r from-slate-600 to-slate-800 text-white font-semibold rounded-full shadow-lg hover:from-slate-500 hover:to-slate-700 transform hover:scale-105 transition-all duration-300"
        >
