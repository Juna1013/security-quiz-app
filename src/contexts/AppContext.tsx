...
const translations = {
  ja: {
    ...
    'description_01': '・間違えた問題の解説をもう一度確認してみましょう',
    'description_02': '・県警のサイバーセキュリティ啓発ページで詳しい情報をチェック',
    'description_03': '・定期的にクイズに挑戦して知識を定着させましょう',
    'description_04': '・家族や友人とも一緒にクイズに挑戦してみてください',
  ...
  en: {
    ...
    'description_01': '・Review the explanations of the questions you answered incorrectly.',
    'description_02': "・Check the prefectural police's cybersecurity awareness page for more details.",
    'description_03': '・Take the quiz regularly to reinforce your knowledge.',
    'description_04': '・Try the quiz together with your family and friends.',
